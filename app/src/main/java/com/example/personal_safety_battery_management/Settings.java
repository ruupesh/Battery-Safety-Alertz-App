          ...
          //---------------------CHARGING ALERT-----------------
                      ...
                      aSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                          ...
                          public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                              ...
                              if (isChecked == true) {
                                  Toast.makeText(getBaseContext(), "Notification turned On", Toast.LENGTH_LONG).show();

                              } else {
                                  Toast.makeText(getBaseContext(), "Notification turned Off", Toast.LENGTH_LONG).show();
                              }
                          }
                      });
